...
xval = 400*(random())*Nutil.randunit(dim)
xval2 = 400*(random())*Nutil.randunit(dim)
xval = np.array([400])
xval2 = np.array([-400])
...
#        net.TrainX(xval2,target,error,500,1)
        net.TrainX(400*(random())*Nutil.randunit(dim),target,error,500,1)
#        net.TrainX(400*(random())*Nutil.randunit(dim),target,error,100,.01)

#    net.UpdateGrad()
 
    net.Update(0.0000001,10.0)#.00000001,100)#.000001,100)#.0000001,10000)#.00000001)

    print "val: ",net.GetVal(xval)," xval: ",xval
    print "val: ",net.GetVal(xval2)," xval: ",xval2
